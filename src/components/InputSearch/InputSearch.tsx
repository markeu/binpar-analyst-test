...
export const InputSearch = ({ value, onChange }: InputSearchProps) => {
    return (
        <div className="flex flex-col gap-6 w-79">
            <div className="relative w-80 min-w-[100px] h-10">
                <input
                    className="peer w-full h-full bg-transparent text-blue-gray-900  outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 border focus:border-2 border-t-transparent focus:border-t-transparent text-md px-3 py-2.5 rounded-[7px] border-blue-gray-500 focus:border-blue-500"
                    placeholder=" "
                    value={value}
                ...
                /><label
                    className="flex w-full h-full select-none pointer-events-none absolute 
                        ...
                        before:w-2.5 before:h-1.5 before:mt-[6.5px] 
                        ...
                        peer-placeholder-shown:leading-[3.75] text-blue-gray-400 peer-focus:text-blue-500 before:border-blue-gray-200 
                        peer-focus:before:!border-blue-500 after:border-blue-gray-200 peer-focus:after:!border-blue-500">
                    Search for Pokémon
                </label>
            </div>
        </div>
